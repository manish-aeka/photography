document.addEventListener("DOMContentLoaded", async () => {
   ...
   */
    ...
    data.categories.forEach((category) => {
        ...
        card.className =
            "category-card w-[420px] bg-white text-gray-900 rounded-xl overflow-hidden shadow-lg transition-transform duration-300 hover:scale-105";
            ...
            i % 6 === 0
                ...
                : i % 5 === 0
                    ...
                    : i % 4 === 0
                        ...
                        : "";
        gallery.innerHTML += `
      <div class="overflow-hidden rounded-lg ${extra} cursor-pointer reveal">
